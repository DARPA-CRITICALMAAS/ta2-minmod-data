...
def run_sparql_query(query, endpoint='http://localhost:9999/blazegraph/sparql', values=False):
    # add prefixes
    final_query = '''
...
def run_minmod_query(query, values=False):
    return run_sparql_query(query, endpoint='http://localhost:9999/blazegraph/sparql', values=values)
